...
import { RequireLoginGuide, RequireLoginUser } from './utilis/Conditions';
import PaymentMethods from './Components/UserComponents/Payment/PaymentMethods';
function App() {
  return (
    <div className="App">
       <Toaster  />
      <Router>
        <Routes>
          ...
          <Route element={<RequireLoginUser />}>
                  ...
                  <Route path="/destination/:id" element={<DestinationDetailPage/>}></Route>
                  <Route path="/guide/:id" element={<GuideDetailPage/>}></Route>
                  {/* Profile */}
                  <Route path="/profile" element={<ProfilePage/>}></Route>
                  <Route path="/requests" element={<UserRequestPage/>}/>
          ...
          <Route element={<RequireLoginGuide/>}>
                ...
                <Route path='/guide_request' element={<GRequestPage/>}/>
          </Route>
